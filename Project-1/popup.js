document.addEventListener("DOMContentLoaded", function () {
  ...
  function exportUserData() {
    const exportData = {
      ...
      statistics: {
        termsReplaced: state.termsReplaced,
      ...
      reader.onload = function (e) {
        try {
          ...
          if (importedData.statistics) {
            state.termsReplaced = importedData.statistics.termsReplaced || 0;
            state.totalReplaced = importedData.statistics.totalReplaced || 0;
            state.lastReset =
              importedData.statistics.lastReset || new Date().toDateString();
          }
