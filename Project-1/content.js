          ...
          if (regex.test(modifiedText)) {
            ...
            if (highlightOnly) {
              ...
              modifiedText = modifiedText.replace(
                regex,
                (match) =>
                  `<span style="background-color: #ffcdd2; border-radius: 3px; padding: 2px;" 
              ...
              modifiedText = modifiedText.replace(regex, (match) => {
                ...
                return `<span style="background-color: #e8f5e9; border-radius: 3px; padding: 2px;" 
  ...
  function updateStats() {
    chrome.storage.local.get(
      ...
      function (data) {
        ...
        const storedDay = data.lastUpdated || "";
